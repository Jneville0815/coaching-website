...
3. Add an `<li>` for it at the top of the list in `blog/index.html`, and remove the "coming soon" line if it is still there:
   `<li><a href="/blog/<slug>.html"><time datetime="YYYY-MM-DD">Mon D, YYYY</time><span class="title">Title</span></a></li>`
